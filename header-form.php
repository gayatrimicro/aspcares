...
<div id="asksuccess" class="sucmesg" style="color: green;display: none;">Inquiry sent successfully</div>
        ...
        <div class="demo">
            <div class="a">
              <input type="text"  name="rx1[]" size="50" required="" placeholder="Input RX Number" class="text-area full wpcf7-form-control wpcf7-text wpcf7-validates-as-required" id="rx1" aria-required="true" style="margin-right: 10px;" >
            </div>

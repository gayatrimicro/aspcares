...
if($_POST){
        ...
        $firstname=$_POST['firstnamerc'];
        $lastname=$_POST['lastnamerc'];
        $locationemail=$_POST['askemailrc'];
        $enquiry=$_POST['askmsgrc']; 
       // $pagelocation = $_POST['pagelocation']; 
        ...
        // if(!empty($query)) {
         ...
         // header("Location:display.php");
            ...
            $subject = "Self funded - request a callback :  $timezone ";

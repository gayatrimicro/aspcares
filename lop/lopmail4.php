...
if($_POST){
        ...
        $lopbtnname=$_POST['lopbtnname3'];
        $lopbtnphone=$_POST['lopbtnphone3'];
        $lopbtnemail=$_POST['lopbtnemail3'];
        $lopbtnadd=$_POST['lopbtnadd3']; 
        $pagename = $_POST['loca'];
        ...
        // if(!empty($query)) {
         ...
         // header("Location:display.php");
            ...
            $subject = "WC Transfer RX : #$randnum $timezone";

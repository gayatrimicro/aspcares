 <header id="header">
            <div class="second-nav">
                <ul>
                    <li><a class="active" href="#" data-popup-open="popup-1"><img src="/assets/images/doctor.svg" alt="doctor" width="25px" class="icon-1" ><span id="icon-hide">&nbsp;&nbsp;ASK A PHARMACIST</span></a></li>
                    <li><a href="#" data-popup-open="popup-2" ><img src="/assets/images/pill.svg" alt="pill" width="25px" class="icon-1"><span id="icon-hide">&nbsp;&nbsp;REQUEST A REFILL</a></li>
                    <li><a href="#contact" data-popup-open="popup-8"><img src="/assets/images/patient.svg" alt="patient" width="25px" class="icon-1"><span id="icon-hide">&nbsp;&nbsp;REFER A PATIENT</a></li>
...
<li id="menu-item-2889" class="menu-item menu-item-type-post_type menu-item-object-product menu-item-2889"><a href="/speciality/hiv-aids/"><span>HIV / AIDS</span></a></li>
 ...
 <li id="menu-item-2887" class="menu-item menu-item-type-post_type menu-item-object-product menu-item-2887"><a href="/speciality/prep/"><span>PrEP</span></a></li>  
                            ...
                            <li id="menu-item-1257" class="menu-item-type-products menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1257"><a href="#"><span>INJURED PATIENTS</span></a>
                                ...
                                <ul class="sub-menu">
                                    <li id="menu-item-2883" class="menu-item menu-item-type-post_type menu-item-object-product menu-item-2883 n1"><a href="http://503bfacility.com/" target="_blank"><span>503 Facility</span> </a></li>
...
<div class="popup" id="pop1" data-popup="popup-1">
                        <div class="popup-inner">
                            <div class="box">
                                <div class="form-img"> <img src="/assets/images/scientist.jpg" alt="pharmacist" class="f1"></div>
                                <div class="pd">
...
<input type="submit" value="Submit" class="wpcf7-form-control wpcf7-submit jt_btn jt_btn_primary" style="float: left;">
                    ...
                    <div class="popup" id="pop2" data-popup="popup-2">
                        <div class="popup-inner">
                            <div class="box">
                                <div class="form-img"><img src="/assets/images/clinical01.jpg" class="f2"></div>
                                <div class="pd">
                                    <div class="academy_form_wrap">
                                            ...
                                            <form id="locationform" method="post" class="wpcf7-form">
                                                ...
                                                <div id="contact_form" class="contact_form">
                                                    <div class="contact_form_row">
                                                        ...
                                                        <span class="wpcf7-form-control-wrap your-name"><input style="font-size: 17px;" required="" type="text" name="locationnum" placeholder="(XXX) XXX-XXXX" size="40" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" id="locationnum" aria-required="true" ></span></div>
                                                        <div class="contact_form_column">
                                                        <!-- <label for="your_mail" class="contact_form_label">Email</label> -->
                                                        <span class="wpcf7-form-control-wrap your-name"><input required="" type="email" placeholder="Email" name="locationemail" size="40" class="wpcf7-form-control wpcf7-text" id="locationemail" aria-invalid="false"></span></div>
                                                        <p></p>
                                                    </div>
                                                    <div class="contact_form_row">
                                                        <div class="contact_form_column">
                                                        <label for="your_name" class="contact_form_label">&nbsp;</label>
                                                        <span class="wpcf7-form-control-wrap your-name" ><input type="text"  name="rx" size="40" required="" placeholder="RX #" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" id="rx" aria-required="true" ></span></div>
                                                                                                                <div class="contact_form_column">
...
<p></p>
                                                    ...
                                                    <div class="contact_form_row">
                                                        <div class="contact_form_column">
<span class="wpcf7-form-control-wrap your-name"><input type="text" required="" id="lopbtnphone" placeholder="Phone" name="lopbtnphone" size="40" class="wpcf7-form-control wpcf7-text" id="lopbtnphone" aria-invalid="false"></span></div>
                                                    </div>
...
<p></p>
                                                    ...
                                                    <div class="contact_form_row">
                                                        <div class="contact_form_column">
<span class="wpcf7-form-control-wrap your-name"><input type="text" required="" id="lopbtnphone2" placeholder="Phone" name="lopbtnphone2" size="40" class="wpcf7-form-control wpcf7-text" id="lopbtnphone" aria-invalid="false"></span></div>
                                                    </div>
...
<p></p>
                                                    ...
                                                    <div class="contact_form_row">
                                                        <div class="contact_form_column">
<span class="wpcf7-form-control-wrap your-name"><input type="text" required="" id="lopbtnphone3" pattern="^(0|[1-9][0-9]*)$" placeholder="Phone" name="lopbtnphone3" size="40" class="wpcf7-form-control wpcf7-text" id="lopbtnphone" aria-invalid="false"></span></div>
                                                    </div>
...
<div class="popup" data-popup="popup-8">
                        <div class="popup-inner poplinks">
                            <div class="box">
                                <div class="form-img" style="padding-top: 10%;"><img src="/assets/images/logo-big.png" alt="logo" class="f2"></div>
                                        ...
                                        <div role="form" class="wpcf7" id="wpcf7-f2786-p32-o2" lang="ko-KR" dir="ltr">
                                            ...
                                            <form id="lopbtnform9" method="post" class="wpcf7-form">
                                                ...
                                                <div id="contact_form" class="contact_form">
                                                    ...
                                                    <div class="contact_form_row">
                                                        <div class="contact_form_column">
                                                        <span class="wpcf7-form-control-wrap your-name"><input type="text" required="" id="lopbtnphone9" placeholder="Phone" name="lopbtnphone" size="40" class="wpcf7-form-control wpcf7-text" id="lopbtnphone" aria-invalid="false"></span></div>
                                                    </div>

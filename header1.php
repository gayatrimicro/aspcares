 ...
 <header id="header">
    ...
    C27.803-4.098,28.81-5.192,30.05-5.554" />
                    ...
                    <nav lang="en" class="menu_container">
                        ...
                        <li id="menu-item-1257" class="mobicontact menu-item-type-products menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1257"><a href="/contact/"><span>CONTACT</span></a>
...
<div id="asksuccess" class="sucmesg" style="color: green;display: none;">Inquiry sent successfully</div>
                    ...
                    <div class="popup" id="pop2" data-popup="popup-2">
                        <div class="popup-inner">
                            <div class="box">
                                <div class="form-img"><img src="https://www.aspcares.com/assets/images/clinical01.jpg" class="f2"></div>
                                <div class="pd">
                                    <div class="academy_form_wrap">
                                                ...
                                                <div id="contact_form" class="contact_form">
                                                    ...
                                                    <div class="contact_form_row">
                                                        ...
                                                        <span class="wpcf7-form-control-wrap your-name" >
                                                            <input type="text"  name="rx" size="40" required="" placeholder="RX #" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" id="rx" aria-required="true" >
                                                        </span>
                                                    </div>
                                                    ...
                                                    <div class="contact_form_column">
                                                      ...
                                                      <!--   <option value="Austin, TX">Austin, TX</option> -->s
                                                    ...
                                                    <div class="contact_submit">
                                                        <input type="submit" value="Submit" class="wpcf7-form-control wpcf7-submit jt_btn jt_btn_primary" style="float: left;">
                                                        <div id="asksuccess2" class="sucmesg" style="color: green;display: none;">Inquiry sent successfully</div>
                                                    </div>

...
if($_POST){
        ...
        // if(!empty($query)) {
         ...
         // header("Location:display.php");
            ...
            $subject = "Help request: #$randnum $timezone";
            $headers  = 'MIME-Version: 1.0' . "\r\n";
            $headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
            $headers .= 'From: Aspcares <help@aspcares.com>' . "\r\n";
            ...
            <tr><td style='font-size:1.3em;' colspan='2'><strong>Details :</strong></td></tr>
                   ...
                   <tr>
                     <td align='left' width='25%'><strong>Question :</strong></td>
                     <td align='left' width='50%'>
                     ".  $question ."</td>
                   </tr>
                   ...
                   mail('help@aspcares.com', $subject, $mail, $headers);
                //   setcookie('tntcon','');
                //   unset($_POST);
                  //echo $mail;
